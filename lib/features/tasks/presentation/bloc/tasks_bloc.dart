...
class TasksBloc extends Bloc<TasksEvent, TasksState> {
  TasksBloc()
      : super(const TasksState(completedVisible: true, tasks: <Task>[])) {
  ...
  Future<void> _onAddTask(AddTask event, Emitter<TasksState> emit) async {
    ...
    emit(TasksState(
        completedVisible: state.completedVisible, tasks: updatedTasks));
  }
  ...
  Future<void> _onToggleVisibilityCompletedFilter(
    ...
    emit(TasksState(
        completedVisible: !state.completedVisible, tasks: state.tasks));
  }
}
